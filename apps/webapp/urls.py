...
urlpatterns = [
    ...
    path('starships/new/', views.StarshipCreateView.as_view(), name='starship_new'),
    path('starships/<int:pk>/', views.StarshipDetailView.as_view(), name='starship_detail'),
    path('starships/<int:pk>/delete/', views.StarshipDeleteView.as_view(), name='starship_delete'),
	path('starships/<int:pk>/update/', views.StarshipUpdateView.as_view(), name='starship_update'),
